...
module.exports.onChat = async ({
    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("rocky") || body.startsWith("jan") || body.startsWith("babu") || body.startsWith("janu")) {
            ...
            const randomReplies = ["hoyasoka, asokanga, report mo pa to, weh, dogka, sino maysabe, sus, weh, ah, dog ka, report mo pa, luh, lt ka ba, asokae, subomoto, luh naragebait ako, weh];
            if (!arr) {
